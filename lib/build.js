...
const getApp = opts => {
  ...
  console.log('DEBUG App config', util.inspect(config))
  console.log('DEBUG App path', path.resolve(opts.tempdir, './App.js'))
  ...
  return new Promise((resolve, reject) => {
    compiler.run((err, stats) => {
      ...
      console.log('DEBUG tempdir', opts.tempdir, fs.readdirSync(opts.tempdir))
      resolve(App)
    })
  })
}
...
const getRoutes = async (App) => {
  console.log('DEBUG App', typeof App, Object.keys(App))
