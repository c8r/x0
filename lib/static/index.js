...
const renderHTML = async (Component, options) => {
  ...
  const initialProps = await getProps(Component, Object.assign({
    html: body
  }, options))
...
const getProps = (Component, options) => typeof Component.getInitialProps === 'function'
  ? Object.assign({}, options, Component.getInitialProps(Object.assign({ Component }, options)))
  : options
